    ...
    >
        ...
        >
          ...
          <div class="card-body">
            ...
            <button
              ...
              @click="openModalEdit(department._id, position._id)"
      ...
      <div class="card-footer">
        <button
          ...
          v-if="department.position.length == 0"
          @click="deleteDepartment(department._id)"
        >
          <i class="fas fa-trash-alt"></i> Xoá phòng ban
        </button>
        <button
          @click="openModalAddPosition(department._id, department.name)"
          data-bs-toggle="modal"
              ...
              <form>
                ...
                <div class="form-group mb-3">
                  ...
                  <input
                    ...
                    aria-expanded="false"
                    :value="position.levels.toString().replaceAll(',', ', ')"
                  />
                ...
                <div class="form-group mb-3">
                  ...
                  <ul class="list-group m-2 px-4">
                    <li class="" v-for="skill in position.skills">
                      {{ skill }}
                    </li>
                  </ul>
                </div>
                ...
                <div class="form-check" v-for="(item, index) in criteria">
                  <div class="row align-items-center">
                      ...
                      <div class="list-group list-group-flush">
                        <label class="list-group-item">
                          ...
                          <a
                            ...
                            ><i class="fas fa-question-circle ms-0"></i
                          ></a>
                        </label>
                      </div>
                    </div>
                    <div class="col-3 text-end">
                      <input
                        class="
                          form-control form-control-sm form-control-color
                          float-end
                        "
                        type="number"
                        v-model="position.criteria[index]"
                      />
                    </div>
                  </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-9">
                      <div class="list-group list-group-flush">
                        <label class="list-group-item">
                          <a
                            class="btn btn-sm btn-danger me-1 ms-n4 py-0"
                            @click="
                              () => {
                    ...
                    <div class="col-3 text-end">
                      <input
                        ...
                        "
                        type="number"
                        v-model="position.questions[index].point"
                      />
                    </div>
                  </div>
                  <div class="collapse" :id="'collapse2' + index">
                    <ul class="list-group ms-5">
                      <li class="" v-for="(item2, index2) in item.detail">
                        {{ item2
                        }}<a
                    ...
                    <div class="input-group my-2">
                      ...
                      <button
                        ...
                        @click="
                          () => {
                            if (question != '') {
                              position.questions[index].detail.push(question);
                              question = '';
                            }
                          }
                        "
