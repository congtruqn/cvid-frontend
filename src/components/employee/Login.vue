      ...
      <div class="container">
        <div class="col-left">
          <div class="login-text">
            ...
            <p>
              Bạn chưa có tài khoản?<br />Đăng ký dễ dàng,<br />
              hoàn toàn miễn phí
            </p>
        ...
        <div class="col-right">
          <div class="login-form">
            ...
            <form>
              ...
              <p>
                <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Quên mật khẩu?</a>
              </p>
            </form>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              ...
              />
              <button class="btn btn-outline-secondary" type="button" id="button-addon2">Lấy mã</button>
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text" id="basic-addon1">Mã OTP</span>
              <input
                type="text"
                class="form-control"
